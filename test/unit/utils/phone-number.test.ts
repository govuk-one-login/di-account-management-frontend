...
describe("phone-number", () => {
  ...
  describe("lengthInRangeWithoutSpaces", () => {
    ...
    it("should return true with leading space and 5 chars", () => {
      expect(lengthInRangeWithoutSpaces(" 12345", 5, 5)).toBe(true);
    });
    ...
    it("should return true with middle space and 5 chars", () => {
      expect(lengthInRangeWithoutSpaces("123 45", 5, 5)).toBe(true);
    });

    it("should return false with leading space and 5 chars with range above", () => {
      expect(lengthInRangeWithoutSpaces(" 12345", 6, 7)).toBe(false);
    });
    ...
    it("should return false with middle space and 5 chars with range above", () => {
      expect(lengthInRangeWithoutSpaces("123 45", 6, 7)).toBe(false);
    });

    it("should return false with leading space and 5 chars with range below", () => {
      expect(lengthInRangeWithoutSpaces(" 12345", 3, 4)).toBe(false);
    });
    ...
    it("should return false with middle space and 5 chars with range below", () => {
      expect(lengthInRangeWithoutSpaces("123 45", 3, 4)).toBe(false);
    });

    it("should return true with numbers and spaces in range", () => {
      expect(lengthInRangeWithoutSpaces(" 123 45 678 901 ", 11, 11)).toBe(true);
    });
  });

  describe("test international uk mobile numbers", () => {
    it("should return true with valid uk mobile domestic", () => {
      expect(containsUKMobileNumber("07911123456")).toBe(true);
    });

    it("should return true with valid uk mobile", () => {
      expect(containsUKMobileNumber("00447911123456")).toBe(true);
    });
    ...
    it("should return false with valid uk mobile without lib country code", () => {
      expect(containsInternationalMobileNumber("07911123456")).toBe(false);
    });

    it("should return true with valid uk mobile without lib country code", () => {
      expect(containsInternationalMobileNumber("00447911123456")).toBe(true);
    });

    it("should return true with valid uk mobile in E164 without lib country code", () => {
      expect(containsInternationalMobileNumber("+447911123456")).toBe(true);
    });

    it("should return true with valid uk mobile in E164 without lib country code with zero", () => {
      expect(containsInternationalMobileNumber("+4407911123456")).toBe(true);
    });
  });
  ...
  describe("test international French mobile numbers", () => {
    it("should return false with valid French mobile without lib country code", () => {
      expect(containsInternationalMobileNumber("0645453322")).toBe(false);
    });

    it("should return true with valid French mobile without lib country code", () => {
      expect(containsInternationalMobileNumber("0033645453322")).toBe(true);
    });

    it("should return true with valid French mobile in E164 without lib country code", () => {
      expect(containsInternationalMobileNumber("+33645453322")).toBe(true);
    });

    it("should return true with valid French mobile in E164 without lib country code with zero", () => {
      expect(containsInternationalMobileNumber("+330645453322")).toBe(true);
    });
  });
  ...
  describe("test international Spanish mobile numbers", () => {
    it("should return false with valid Spanish mobile without lib country code", () => {
      expect(containsInternationalMobileNumber("608453322")).toBe(false);
    });

    it("should return true with valid Spanish mobile with 00XX formar country code", () => {
      expect(containsInternationalMobileNumber("0034608453322")).toBe(true);
    });

    it("should return true with valid Spanish mobile in E164 without lib country code", () => {
      expect(containsInternationalMobileNumber("+34608453322")).toBe(true);
    });
  });

  describe("prependInternationalPrefix", () => {
    it("should prepend + to an international number without the prefix", () => {
      expect(convertInternationalPhoneNumberToE164Format("34608453322")).toBe(
        "+34608453322"
      );
    });

    it("should replace 00 with + in an international number using the prefix format 00XX", () => {
      expect(convertInternationalPhoneNumberToE164Format("0034608453322")).toBe(
        "+34608453322"
      );
    });
