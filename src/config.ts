...
const DBT_APPLY_FOR_AN_EXPORT = "Xj93G5rMO2CsouiG8DJf36siQRk";
const DBT_APPLY_FOR_AN_EXPORT_NON_PROD = "dbtApplyForAnExportCertificate";
...
export const getAllowedAccountListClientIDs: string[] = [
  ...
  DBT_APPLY_FOR_AN_EXPORT,
  DBT_APPLY_FOR_AN_EXPORT_NON_PROD,
];
