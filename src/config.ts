...
const OFQUAL_NON_PROD = "TGygWFxGDNn8ItyaecWCopqIX3s";
const MODERN_SLAVERY_NON_PROD = "pDqO7_Hu-pq5wam5I4MlURXrv5k";
const DBS_PROD = "Dw7Cxas8W7O2usHMHok95elKDRU";
const DBS_NON_PROD = "dbs";
const DBS_CHECK_PROD = "RqFZ83csmS4Mi4Y7s7ohD9-ekwU";
const MANAGE_APPRENTICESHIPS_NON_PROD = "x3F_Iu0LgqJpegY5ni0QSB0uezw";
const CRIMINAL_INJURIES_COMPENSATION_NON_PROD = "bGAwNKM0XvnxCAuDQ_rMhhP3dxM";
...
const CONNECT_FAMILIES_TO_SUPPORT_NON_PROD = "cqGoT1LYLsjn-iwGcDTzamckhZU";
...
export const getAllowedAccountListClientIDs: string[] = [
  ...
  OFQUAL_NON_PROD,
  MODERN_SLAVERY_NON_PROD,
  MANAGE_APPRENTICESHIPS_NON_PROD,
  FIND_AND_APPLY_FOR_A_GRANT_PROD,
  FIND_AND_APPLY_FOR_A_GRANT_NON_PROD,
  CRIMINAL_INJURIES_COMPENSATION_NON_PROD,
  "gov-uk",
  "lite",
  "ofqual",
  "modernSlavery",
  ...
  "ukmcab",
  CONNECT_FAMILIES_TO_SUPPORT_NON_PROD,
  "manageFamilySupport",
